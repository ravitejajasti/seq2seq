...
if __name__ == "__main__":
    ...
    parser.add_argument("--datapath", type=str, default="seq2seq-polynomial-master/data/train.txt")
    parser.add_argument("--trainpath", type=str, default="seq2seq-polynomial-master/data/train_set.txt")
    parser.add_argument("--testpath", type=str, default="seq2seq-polynomial-master/data/test_set.txt")
    ...
    with open(args.datapath) as fi:
        pairs = fi.read()[:10000].splitlines()
