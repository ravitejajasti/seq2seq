...
if __name__ == "__main__":
    ...
    parser.add_argument("--dirpath", type=str, default="seq2seq-polynomial-master/models/best")
    parser.add_argument("--train_path", type=str, default="seq2seq-polynomial-master/data/train_set.txt")
    parser.add_argument("--test_path", type=str, default="seq2seq-polynomial-master/data/test_set.txt")
